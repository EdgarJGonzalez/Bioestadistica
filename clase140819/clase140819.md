...
_RETO: ¿Que es una lista (*list*)? ¿En que difiere con una base de datos (*data frame*)? Lean como una lista el archivo_ *datos_alumnos.xls*. _¿Es este un mejor formato para manejar una base de datos?_
