...
_RETO1: Cuando almacenamos datos_*alumnos*_*corregidos.csv* _con la funcion **write.csv()** esta agrego una columna con el numero de fila. Almacenen el archivo sin esta columna._
