...
2. Abran R, cambien el directorio de trabajo al Escritorio y lean el archivo usando la funcion **read.csv()**, leyendo encabezados (_header = T_) y almacenando la base de datos con el nombre _datos._
