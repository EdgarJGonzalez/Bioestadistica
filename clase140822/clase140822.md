...
_OBSERVACIONES: Para ponerles nombres a los ejes y titulo a las graficas, fijense en el manual de cada funcion: basta que pongan main = "Tituolo",xlab = "Eje X", ylab = "Eje Y" como opciones en las funciones._
