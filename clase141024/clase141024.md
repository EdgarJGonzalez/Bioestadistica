...
**Supuesto**: La variable de interés se distribuye normal con parámetros µ (desconocida) y sigma (conocida).
...
**Supuesto**: La variable de interés se distribuye normal con parámetros µ (conocida) y sigma (desconocida).
...
##### 3. IC para diferencia de medias (µ_x – µ_y) cuando las sigmas son conocidas
...
##### 4. IC para diferencia de medias (µ_x – µ_y) cuando sigma_x = sigma_y desconocida
...
##### 5. IC para diferencia de medias cuando las sigmas son desconocidas
...
<img src="./more/IC11.png" height="70px" />
...
4. IC 7: usen **rbinom()**, size = 1000, p = 0.5
...
¿Qué significa que el 0 esté dentro de los IC 3, 5 y 6?