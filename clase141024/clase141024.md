...
1. IC 1,2 y 3: usen **rnorm()**, con µ = 1.70 y sigma = 0.01
2. IC 4: usen **rbinom()**, size = 1000, p = 0.5
3. IC 5: cambien el tamaño de muestra a 50
4. IC 6: usen **rpois()** con lambda = 2.5
