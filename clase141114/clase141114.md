...
Entonces, para usar **anova(x~g)** tenemos que tener un vector *x* con los valores de la variable X observados en la población, y un vector *g* con el grupo al que pertenece cada dato x observado.

*ACTIVIDAD1*:

Crecimiento (mm) de una sp de planta bajo 5 niveles de humedad relativa diferentes
